    ...
    <div class="container-fluid">
     ...
     <div class="card-box">
        ...
        if (!empty($url)) {
          ...
          <div class="row mb-3">
               <div class="btn-group">
                <a class="btn btn-link btn-email" target="_blank" href="http://localhost/fiverr/walkit_app/index.php?ref=<?=$url?>">http://localhost/fiverr/walkit_app/index.php?ref=<?=$url?></a>
                <button type="button" class="btn btn-default btn-copy js-tooltip js-copy" data-toggle="tooltip" data-placement="bottom" data-copy="http://localhost/fiverr/walkit_app/index.php?ref=<?=$url?>" title="Copy to clipboard">
                 <i class="fa fa-fw fa-md fa-copy icon"></i>
                </button>
          </div>
            </div>
            <?php
        ...
        <form class="form-horizontal" method="post" autocomplete="off" action="settings.php" enctype="multipart/form-data">
          
          <div class="row mb-3">
            <div class="col-lg-6">
              <label for="url">Reference name for users</label>
                  <input type="text" class="form-control" value="<?= $url ?>" name="url" required placeholder="eg. MacDonalds or Chicken_Republic">
            </div>
          </div>
          ...
          <div class="row mb-3">
           ...
           <div class="row mb-3">
            <div class="col">
              ...
              <input type="text" class="form-control" value="<?= $company_name ?? '' ?>" name="company_name" required>
            </div>

            <div class="col">
              <label for="full_name">Address</label>
              <input type="text" class="form-control" value="<?= $address ?? '' ?>" id="to" name="address" required>
            </div>
          </div>
            ...
            <div class="col">
              <label for="full_name">Mobile</label>
               <div class="input-group ">
                        ...
                        <input type="text" name="mobile" class="form-control" value="<?= $mobile_no ?? '' ?>" placeholder="Your Phone Number" required>
